<?php
	 ...
	 * Det er ikke! forventet at dere skal kunne lage slike funksjoner som dette (preg_match er ganske komplisert), så her er det bare å kopiere andres arbeid ;)
	...
	if ( isset( $_POST['reg-send'] ) )
	{
		...
		/* Data lagres i matrise og skrives ut */
		$skjema = array( 'fornavn' => $_POST['fornavn'], 'etternavn' => $_POST['etternavn'], 'epost' => $_POST['epost'], 'kjønn' => $_POST['kjonn'] );
		echo "Følgende data har blitt registrert: <br />";
		foreach( $skjema as $felt => $verdi )
		{
			echo $felt . ": " . $verdi . "<br />";
		}
		...
		{
			echo " Men, følgende bør rettes .. <br>";
...
<head>
<meta charset="utf-8">
<title>Løsningsforslag L4-4</title>
</head>
